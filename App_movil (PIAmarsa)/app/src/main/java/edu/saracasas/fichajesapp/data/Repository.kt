...
class Repository(private val remoteDatasource: RemoteDatasource) {
    ...
    suspend fun getFichajesByEmpleadoIdSemanaActual(empleado_id: Long, rango: RangoFechasDTO): List<Fichaje>? {
        try {
            return remoteDatasource.getFichajesByEmpleadoIdSemanaActual(empleado_id, rango).body()
        } catch (e: Exception) {
            e.printStackTrace()
            return emptyList()
        }
    ...
    suspend fun getHorariosByEmpleadoId(empleadoId: Long, start: String, end: String):
        ...
        try {
            return remoteDatasource.getHorariosByEmpleadoId(empleadoId, start, end).body()
        } catch (e: Exception) {
            e.printStackTrace()
            return null
        }
    ...
    suspend fun getVacacionesByEmpleadoId(empleadoId: Long): List<Ausencia>? {
        try {
            return remoteDatasource.getVacacionesByEmpleadoId(empleadoId).body()
        } catch (e: Exception) {
            e.printStackTrace()
            return null
        }
