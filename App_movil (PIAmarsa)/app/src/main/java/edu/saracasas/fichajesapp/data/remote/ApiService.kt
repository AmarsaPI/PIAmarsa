...
interface ApiService {
    ...
    @POST("fichajes/empleado/{empleadoId}/SemanaActual")
    suspend fun getFichajesByEmpleadoIdSemanActual(
        @Path("empleadoId") empleado_id: Long,
        @Body rango: RangoFechasDTO): Response<List<Fichaje>>
    ...
    @GET("ausencias/empleado/{empleadoId}")
    suspend fun getVacacionesByEmpleadoId(
        @Path("empleadoId") empleadoId: Long): Response<List<Ausencia>?>
}