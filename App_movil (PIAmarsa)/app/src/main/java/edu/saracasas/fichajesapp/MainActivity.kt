...
import edu.saracasas.fichajesapp.ui.screens.HorarioScreen
...
fun BottomNavigationBar(selectedIndex: Int, onItemSelected: (Int) -> Unit){
    NavigationBar(
        containerColor = Color(0x00979EC4),
...
@Composable
fun PerfilMenu(vm: MainViewModel) {
