# Fase 5. Pruebas finales, documentacion y cierre

Este directorio agrupa los entregables finales del Proyecto Intermodular PIAmarsa.

## Entregables incluidos

- [Informe de pruebas finales](Informe_Pruebas_Finales.md)
- [Manual de usuario funcional](Manual_Usuario.md)
...
| --- | --- | --- |
| Pruebas de aceptacion, rendimiento, seguridad y trazabilidad | `Informe_Pruebas_Finales.md` | Completo |
| Manual de usuario con flujos de trabajo | `Manual_Usuario.md` | Completo |
| Documentacion tecnica, arquitectura, BD y codigo | `Documentacion_Tecnica_Instalacion_Despliegue.md` | Completo |
