...
/**
 * Controlador web para plantillas, horarios reales, festivos
 * y vistas/acciones relacionadas (asignación, gestión y borrado por rango).
 */
@Controller
public class HorarioController {
	...
	/**
	 * Crea registros de PlantillaHorario a partir de eventos JSON (inicio/fin).
	 *
	 * @param nombre nombre de la plantilla
	 * @param json JSON con eventos del calendario
	 * @return redirect a crear_plantilla con ?success o ?error
	 */
	 ...
	 * @return vista crear_plantilla o redirect a login si no hay sesión
	 */
	...
	/**
	 * Vista para asignar horarios a empleados usando plantillas existentes.
	 *
	 * @param model modelo de la vista
	 * @param session sesión actual
	 * @return vista asignar_horario o redirect a login
	 */
	...
	/**
	 * Gestión de plantillas: lista agrupada por nombre y detalle completo.
	 *
	 * @param model modelo de la vista
	 * @param session sesión actual
	 * @return vista gestion_plantillas o redirect a login
	 */
	...
	/**
	 * Elimina horarios reales de un empleado en el rango [start, end).
	 *
	 * @param empleadoId id del empleado
	 * @param startStr inicio incluido (yyyy-MM-dd)
	 * @param endStr fin excluido (yyyy-MM-dd)
	 * @return 200 con 'cantidad' eliminada; 500 si hay error
	 */
	...
	/**
	 * Envía una solicitud de cambio de horario con el usuario en sesión.
	 *
	 * @param solicitud datos de la solicitud
	 * @param session sesión actual
	 * @return redirect a /horario_personal con mensaje
	 */
	...
	/**
	 * Devuelve eventos globales de horarios en el rango [start, end] para el calendario.
	 *
	 * @param start inicio (yyyy-MM-dd)
	 * @param end fin (yyyy-MM-dd)
	 * @return 200 con lista de eventos; 500 si falla
	 */
	...
	/**
	 * Devuelve eventos de festivos de un empleado.
	 *
	 * @param empleadoId id del empleado (opcional)
	 * @return lista de eventos de festivo (vacía si no se pasa id)
	 */
	...
	/**
	 * Devuelve eventos de horarios de un empleado en el rango [start, end].
	 *
	 * @param empleadoId id del empleado
	 * @param start inicio (yyyy-MM-dd)
	 * @param end fin (yyyy-MM-dd)
	...
	/**
	 * Devuelve la vista previa de una plantilla (nombre y turnos).
	 *
	 * @param id id de un registro de PlantillaHorario
	 * @return 200 con {nombrePlantilla, turnos} o 404 si no existe
	 */
	...
	/**
	 * Crea o actualiza un horario real (si ya existe mismo empleado+fecha).
	 *
	 * @param horario entidad Horario
	 * @return 201 con idGenerado o 500 si falla
	 */
	...
	/**
	 * Elimina un horario real por ID.
	 *
	 * @param id id del horario
	 * @return 200 si elimina; 404 si no existe; 500 si hay error de datos
	 */
	...
	/**
	 * Devuelve los turnos del usuario en sesión como eventos de calendario.
	 *
	 * @param session sesión HTTP (requiere usuario logueado)
	 * @param start rango opcional (no se filtra aquí)
	 * @param end rango opcional (no se filtra aquí)
	 * @return 200 con eventos o 401 si no hay sesión
	 */
	...
	/**
	 * Devuelve los festivos del usuario en sesión como eventos de fondo.
	 *
	 * @param session sesión HTTP
	 * @return 200 con eventos
	 */
	...
	/**
	 * Exporta a PDF el horario del usuario en sesión (tabla semanal simple).
	 *
	...
	/**
	 * Exporta a PDF el cuadrante mensual del equipo (vista vertical por semanas).
	 *
	 * @param response respuesta HTTP
	 * @throws Exception si falla la generación del PDF
	 */
