...
-- HORARIOS
INSERT INTO horarios (dia_semana, hora_inicio, hora_fin, empleado_id) VALUES ('MONDAY', '09:00:00', '14:00:00', 4);
INSERT INTO horarios (dia_semana, hora_inicio, hora_fin, empleado_id) VALUES ('TUESDAY', '09:00:00', '14:00:00', 3);

-- FICHAJES
INSERT INTO fichajes (fecha_entrada, fecha_salida, empleado_id) VALUES ('2025-03-01 09:05:00', '2025-03-01 14:00:00', 4);
